...
public class waits {
	public static void main(String args[]) throws InterruptedException {
		...
		WebElement firstname=driver.findElement(By.xpath("//input[@class='inputtext _58mg _5dba _2ph-' and @name='firstname']"));
		//This is fluent wait
		...
		WebElement mobOrEmail=driver.findElement(By.xpath("//input[@class='inputtext 58mg _5dba _2ph-' and @name='reg_email_']"));
		mobOrEmail.sendKeys("8208375235");
		
		WebElement newpass=driver.findElement(By.xpath("//input[@class='inputtext 58mg _5dba _2ph-' and @name='reg_passwd_']"));
